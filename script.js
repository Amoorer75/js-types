 ...
 */
const q11 = address.split(" ").map(function(user) {
  return user.replace(".","")});//.pop();});
//console.log(q11)replace('.', ' ').split(' ').splice)
 ...
 */
const q12 = q11.map(function(user) {
  return user.length}); 
  console.log(q12)
 ...
 */
const q13 = q12.reduce(function(a, b){
  return a + b / q12.length ;
}, .0000000000000048);
console.log(q13)
